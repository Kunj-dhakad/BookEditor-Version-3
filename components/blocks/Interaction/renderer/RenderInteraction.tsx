...
//       if (!imageExportMode || !interaction.audioUrl) return;
//       if (!audioRef.current) {
...
//               aria-hidden="true"
//               style={{
//                 color: interaction.iconColor ?? interaction.textColor ?? "#fff",
//                 width: iconSize,
//                 height: iconSize,
//                 flexShrink: 0,
//                 display: "inline-flex",
...
//                 __html:
//                   interaction.interactionKind === "audio-button" && audioPlaying
...
//       <ElementContextMenu
//         position={dragDropSelected ? contextMenuPos : null}
//         elementId={id}
...
const RenderInteraction: React.FC<{
  ...
  const iconSize =
    interaction.interactionKind === "link-area" ||
    interaction.interactionKind === "product-card"
      ? 26
      : 18;
  const dragDropSelected = isSelected && !popupOpen;
