...
//   const [mounted, setMounted] = useState(false); // animation ke liye
...
//     // ✅ requestAnimationFrame loop — canvas pan/zoom ke saath bhi sync rahega
//     let rafId: number;
//     const loop = () => {
//       updatePos();
...
//   // ✅ Outside click — document mousedown pe close
//   useEffect(() => {
...
//       ref={popupRef}
//       data-element="true"
//       className="fixed z-9999 kd-context-menu w-72"
//       style={{
//         top: pos.top,
//         left: pos.left,
...
//         onBlur={() => updateButton({ link })}
//         onKeyDown={(e) => {
//           if (e.key === "Enter") {
//             updateButton({ link });
//             onClose(); // ✅ Enter pe bhi close
//           }
//           if (e.key === "Escape") onClose(); // ✅ Escape pe bhi close
//         }}
//         placeholder="Paste a link"
//         className="p-2 kd-linkAdd-input w-full"
//       />
//     </div>
//   );
// };
